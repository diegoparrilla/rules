 ...
 * @overview Look up in Auth0 IP Signals and add the name of the blacklist to the user's metadata.
 * @gallery true
 ...
 * for the service and [the maximum number of daily requests is 40000](https://community.auth0.com/t/how-to-obtain-an-auth0-signals-api-key/42048).
 * You can read the latest full [Terms of Service here](https://auth0.com/signals/terms-of-service).
 * 
 *
 */
